...
import mainbannersecond from '../assets/main-banner_2.png';
...
export const Mainbanner = () => {
  return (
    <div className="relative w-full">
      ...
      <img src={mainbannersecond} alt="Grocery Banner" className="w-full md:hidden" /> 

      <div className="absolute inset-0 flex flex-col justify-center items-center md:items-start px-4 md:px-10 lg:px-24">
